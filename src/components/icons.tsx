...
export const Icons = {
  ...
  notion: ({ width, height }: { width?: number; height?: number }) => (
    <svg
      width={width || 100}
      height={height || 100}
      viewBox="0 0 100 100"
  ...
  n8n: ({ width, height }: { width?: number; height?: number }) => (
    <img
      src="/n8n-logo.png"
      alt="n8n"
      width={width || 100}
  ...
  shopify: ({ width, height }: { width?: number; height?: number }) => (
    <img
  ...
  tally: ({ width, height }: { width?: number; height?: number }) => (
    <img
      src="/tally-logo.avif"
      alt="tally"
      width={width || 100}
  ...
  sheets: ({ width, height }: { width?: number; height?: number }) => (
    <img
      src="/sheets-logo.png"
      alt="sheets"
      width={width || 100}
  ...
  slack: ({ width, height }: { width?: number; height?: number }) => (
    <img
      src="/slack-logo.png"
      alt="slack"
      width={width || 100}
  ...
  stripe: ({ width, height }: { width?: number; height?: number }) => (
    <img
      src="/stripe-logo.png"
      alt="stripe"
      width={width || 100}
  ...
  pdf: ({ width, height }: { width?: number; height?: number }) => (
    <img
      src="/pdf-logo.png"
      alt="pdf"
      width={width || 100}
  ...
  gmail: ({ width, height }: { width?: number; height?: number }) => (
    <img
      src="/gmail-logo.png"
      alt="gmail"
      width={width || 100}
  ...
  googleDrive: ({ width, height }: { width?: number; height?: number }) => (
    <svg
      width={width || 100}
      height={height || 100}
      viewBox="0 0 87.3 78"
  ...
  whatsapp: ({ width, height }: { width?: number; height?: number }) => (
    <svg
      width={width || 100}
      height={height || 100}
  ...
  googleDocs: ({ width, height }: { width?: number; height?: number }) => (
    <svg
      width={width || 47}
      height={height || 65}
      viewBox="0 0 47 65"
  ...
  messenger: ({ width, height }: { width?: number; height?: number }) => (
    <svg
      width={width || 100}
      height={height || 100}
      viewBox="0 0 48 48"
  ...
  user: ({ width, height }: { width?: number; height?: number }) => (
    <svg
      width={width || 24}
      height={height || 24}
      viewBox="0 0 24 24"
