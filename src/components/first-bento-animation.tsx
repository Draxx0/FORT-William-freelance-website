...
export function ReasoningBasic() {
  const reasoningText = `Très bien, j'ai envoyer une invitation à tous les membres de l'équipe pour une réunion mardi à 10h et j'ai ajouter cette dernière dans votre agenda.`;
    ...
    >
      ...
      >
        <div className="flex items-end justify-end gap-3">
          ...
          >
            <p className="text-sm">
              Hey, j&apos;ai besoin d&apos;aide pour planifier un rendez-vous
              d&apos;équipe, envoie une invitation à tous les membres de
              l&apos;équipe pour une réunion mardi à 10h.
            </p>
          </motion.div>
        ...
        <div className="flex items-start gap-2">
          <div className="flex items-center bg-primary rounded-full size-10 flex-shrink-0 justify-center shadow-[0_0_10px_rgba(0,0,0,0.05)] border border-border">
