      ...
      <div className="relative flex h-full w-full items-center justify-center overflow-hidden">
        <div className="relative flex h-full w-full items-center justify-center translate-y-0 md:translate-y-32">
          <OrbitingCircles
            ...
            speed={1}
          >
            <Icons.googleDrive width={40} height={40} />
            <Icons.googleDocs width={40} height={40} />
            <Icons.messenger width={40} height={40} />
          </OrbitingCircles>

          <OrbitingCircles index={1} iconSize={20} speed={0.5}>
            <Icons.whatsapp width={40} height={40} />
            <Icons.notion width={40} height={40} />
            <Icons.googleDocs width={40} height={40} />
          </OrbitingCircles>
