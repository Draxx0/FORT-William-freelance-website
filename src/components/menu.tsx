                    ...
                    {item.content.main && (
                      <li className="row-span-3 group">
                        <NavigationMenuLink asChild>
                          <Link
                            className="flex group h-full w-full select-none flex-col justify-end rounded-md bg-primary/10 from-muted/50 to-muted  no-underline outline-none p-2 focus:bg-muted"
                            href={item.content.main.href}
                          >
                            {item.content.main.image}
                            <div className="mb-2 mt-4 text-lg font-medium group-focus:text-primary group-hover:text-primary">
